...
# @views function DikeInjection_2D(igg; figname=figname,nx=nx, ny=ny); 
    ...
    εbg                     = 1e-10/s             # background strain rate
    ...
    if toy == true
        ...
        elseif thermal_perturbation == :circular_anomaly
            ...
            circular_viscosity_anomaly!(thermal.T, anomaly, phase_v, xc, yc, radius, xvi)
            circular_viscosity_anomaly_center!(phase_c, xc, yc, radius, xci)

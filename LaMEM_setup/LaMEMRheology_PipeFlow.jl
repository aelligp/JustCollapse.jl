...
function init_rheology(CharDim; is_compressible=false, linear=true)
    ...
    if linear == true
        ...
        creep_conduit = LinearViscous(; η=1e16 * Pa * s)                         # viscosity of magma
        mush = LinearViscous(; η=1e18 * Pa * s)
        g           = 9.81m / s^2
    else # nonlinear
    ...
    return rheology = (
        ...
        SetMaterialParams(;
            ...
            CompositeRheology   = CompositeRheology((mush,el_magma)),
            Melting             = MeltingParam_Smooth3rdOrder(a=3043.0,b=-10552.0,c=12204.9,d=-4709.0),
            CharDim             = CharDim,
            ),
        ...
        SetMaterialParams(;
            Phase               = 3,
            Density             = ConstantDensity(ρ=2200kg/m^3),

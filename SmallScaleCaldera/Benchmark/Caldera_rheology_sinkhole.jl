...
function init_rheologies(layers, oxd_wt, fric_angle; linear = false, incompressible = true, plastic = true, magma = false, softening_C=false, softening_ϕ=false)
    ...
    disl_top = LinearViscous(η = 1.0e23)
    disl_bot = LinearViscous(η = 1.0e21)

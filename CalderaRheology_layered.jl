...
function init_rheology(CharDim; is_compressible=false, linear=true)
    ...
    pl_volc = DruckerPrager_regularised(; C=5MPa, ϕ=ϕ_fric, η_vp=η_reg, Ψ=0.0, softening_C=soft_C)
    ...
    if linear == true
        ...
        creep_volcano_1      = SetDiffusionCreep(Diffusion.wet_anorthite_rybacki_2006) # viscosity of lithosphere
        creep_volcano_2      = SetDiffusionCreep(Diffusion.wet_quartzite_Rutter_2004) # viscosity of lithosphere
